...
const uint16_t this_node = 012;   // Address of this node in Octal format (01,02,~~)
const uint16_t node01 = 02;      // Address of the other node in Octal format(Receiver node)
unsigned long unit_number = 6;
